                ...
                if printer.is_file() :
                    ...
                    if printerParam["IP"] != "" and printerParam["PKA"] != "" :
                        ...
                        try :
                            ...
                            errorList.append(printer.name + " - Error - Host does not respond")
                                            ...
                                            if "gcode" in file : 
                                                ...
                                                if prusaMini.exists_gcode(printerPath) : 
                                                    ...
                                                    try :
                                                        ...
                                                        errorList.append(printer.name + " - Error - during sending file : " + printerPath)
                                                    ...
                                                    if not errorDuringSending : 
                                                        if ret.status_code == 201 :
                                                            ...
                                                            errorList.append(printer.name + " - Error - Error : Unauthorized - Check IP & Port & PKA - sending file : " + printerPath)
                                                        elif ret.status_code == 409 :
                                                            print(" -> Error : File already exists") 
                                                        else :
                                                            print(" -> Error : " + str(ret.status_code) + " text "  + str(ret.text))
                                                            errorList.append(printer.name + " - Error - during sending file : " + printerPath + " Error code : " + str(ret.status_code) + " - Error text "  + str(ret.text))
                                ...
                                for fileName, filePrinterPath in flatten(fileDict) :
                                    if fileName not in listFileToSend :
                                        ...
                                        if ret.status_code == 204 :
                                            ...
                                            print(" -> Error : " + str(ret.status_code) + " text "  + str(ret.text))
                                            errorList.append(printer.name + " - Error - during deleting file : " + filePrinterPath + " Error code : " + str(ret.status_code) + " - Error text "  + str(ret.text))
                                # Delete Folders
                                for folderPrinterPath in flattenFolder(fileDict) :
                                    if folderPrinterPath not in listFolderToSend :
                                        ...
                                        if ret.status_code == 204 :
                                            ...
                                            print(" -> Error : " + str(ret.status_code) + " text "  + str(ret.text))
                                            errorList.append(printer.name + " - Error - during deleting folder : " + folderPrinterPath + " Error code : " + str(ret.status_code) + " - Error text "  + str(ret.text))
                                    
                    else :
                        print("  -> Warning : IP PKA not found : " + str(printerParam))
                        errorList.append(printer.name + " - Error -  IP PKA not found : " + str(printerParam))
    if errorList != [] :
        print("\n\nList of errors : ")
